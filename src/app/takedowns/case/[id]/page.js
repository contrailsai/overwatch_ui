  ...
  return (
    <div className="flex flex-col h-full bg-muted/10">
      ...
      <div className="flex-1 overflow-hidden grid grid-cols-1 lg:grid-cols-12">
        ...
        <div className="lg:col-span-4 bg-background border-l h-full flex flex-col">
                        ...
                        <CardContent className="p-4 space-y-4">
                            ...
                            {post?.signedImageUrl && (
                                <div className="aspect-square rounded-md bg-muted overflow-hidden relative group">
                                    <img src={post.signedImageUrl} className="w-full h-full object-cover transition-transform group-hover:scale-105" alt="Evidence" />
                                </div>
                            )}
