...
import {
    ...
    TrendingDown, Smile, ExternalLink, Search,
    BadgeCheck, Calendar,
                            ...
                            <div className="flex items-center justify-between mb-2">
                                <div className="flex flex-col items-start gap-2">
                                    ...
                                    <div className="flex items-baseline gap-1.5 mb-3">
                                        ...
                                        <span className="text-[11px] font-bold text-slate-500 leading-none">advertisers found</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col gap-4 w-full lg:flex-1">
                                    <div className="flex flex-col gap-3 w-full">
                                        ...
                                        <div className="grid grid-cols-2 lg:flex lg:flex-wrap items-start gap-2.5 sm:gap-3 w-full">
                                            ...
                                            <div className="space-y-1.5 w-full lg:w-auto lg:flex-1 lg:max-w-[160px]">
                    ...
                    <table className="min-w-full border-separate border-spacing-0">
                        <thead className="sticky top-0 z-20 text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                            <tr className="bg-slate-50/90 backdrop-blur-md">
                                ...
                                <th scope="col" className="px-6 py-4 text-left border-b border-slate-100">Page Name</th>
                                <th scope="col" className="px-6 py-4 text-left border-b border-slate-100">Platform</th>
                                <th
                                    scope="col"
                                    onClick={() => handleSortChange('ads')}
                                    className="px-6 py-4 text-left border-b border-slate-100 cursor-pointer hover:bg-slate-100/50 transition-colors select-none"
                                >
                                    <div className="flex items-center">Ads<SortIcon field="ads" /></div>
                                </th>
                                <th
                                    scope="col"
                                ...
                                <tr>
                                    <td colSpan={7} className="px-6 py-20 text-center">
                                        <div className="flex flex-col items-center justify-center text-slate-400">
                                            ...
                                            <h3 className="text-lg font-bold text-slate-900 mb-1">No advertisers found</h3>
                                            <p className="text-sm text-slate-500 max-w-[280px] leading-relaxed mx-auto mb-6">
                                                We couldn't find any advertisers matching your current filters. Try adjusting your search criteria.
                                            </p>
                                            <Button
                                                variant="outline"
                                                size="sm"
                    ...
                    {localProfiles.length === 0 ? (
                        <div className="bg-white rounded-2xl border border-slate-200 p-8 text-center shadow-sm">
                            ...
                            <p className="text-sm text-slate-500 leading-relaxed mb-6">
                                We couldn't find any advertisers matching your current filters.
                            </p>
                            <Button
                                variant="outline"
                                size="sm"
